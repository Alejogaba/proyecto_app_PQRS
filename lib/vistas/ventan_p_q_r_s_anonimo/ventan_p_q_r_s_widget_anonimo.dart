...
import 'barra_carga_anonimo.dart';
import 'graficos_barra_anonimo.dart';
import 'tarjeta_pqrs_anonimo.dart';
import 'ventan_p_q_r_s_model_anonimo.dart';
export 'ventan_p_q_r_s_model_anonimo.dart';

class VentanPQRSWidgetAnonimo extends StatefulWidget {
  const VentanPQRSWidgetAnonimo({Key? key}) : super(key: key);

  @override
  _VentanPQRSWidgetAnonimoState createState() =>
      _VentanPQRSWidgetAnonimoState();
}

class _VentanPQRSWidgetAnonimoState extends State<VentanPQRSWidgetAnonimo> {
  late VentanPQRSModelAnonimo _model;
                              ...
                              child: Container(
                                ...
                                child: FutureBuilder<List<Pqrs>>(
                                    future: ControladorPQRS().cargarPQRS(
                                        ...
                                        textoBusqueda:
                                            _model.textControllerBuscar.text),
