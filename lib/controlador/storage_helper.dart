...
class StorageHelper {
  ...
  Future<void> subirArchivoBase64(String base64Data, String nombreArchivo,
    ...
    final storageRef =
        firebaseRef.child('pqrs/$carpeta/$nombreArchivo');
    await storageRef
        .putData(bytes)
  ...
  void descargarArchivo(String id, String nombreArchivo) {
    AnchorElement anchorElement = AnchorElement(
        href:
            'https://firebasestorage.googleapis.com/v0/b/bdpqrs-2623b.appspot.com/o/pqrs%2F$id?alt=media&token=2c8d22c5-9e07-4e57-b83d-7485432a3741');
